...
bool IsModelValid(RL_Model model)
{
    bool result = false;
...
bool IsMaterialValid(RL_Material material)
{
    bool result = false;
...
void UpdateModelAnimationBones(RL_Model model, RL_ModelAnimation anim, int frame)
{
