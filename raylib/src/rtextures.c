...
bool IsImageValid(RL_Image image)
{
    bool result = false;
...
bool IsTextureValid(RL_Texture2D texture)
{
    bool result = false;
...
bool IsRenderTextureValid(RL_RenderTexture2D target)
{
    bool result = false;
...
RL_Color ColorLerp(RL_Color color1, RL_Color color2, float factor)
{
    RL_Color color = { 0 };
