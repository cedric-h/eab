...
typedef struct RL_rAudioBuffer RL_rAudioBuffer;
typedef struct RL_rAudioProcessor RL_rAudioProcessor;

// RL_AudioStream, custom audio stream
typedef struct RL_AudioStream {
    RL_rAudioBuffer *buffer;       // Pointer to internal data used by the audio system
    RL_rAudioProcessor *processor; // Pointer to internal data processor, useful for audio effects
...
RLAPI bool RL_IsWindowHidden(void);                                  // Check if window is currently hidden
RLAPI bool RL_IsWindowMinimized(void);                               // Check if window is currently minimized
RLAPI bool RL_IsWindowMaximized(void);                               // Check if window is currently maximized
RLAPI bool RL_IsWindowFocused(void);                                 // Check if window is currently focused
...
RLAPI void RL_SetWindowState(unsigned int flags);                    // Set window configuration state using flags
RLAPI void RL_ClearWindowState(unsigned int flags);                  // Clear window configuration state flags
RLAPI void RL_ToggleFullscreen(void);                                // Toggle window state: fullscreen/windowed, resizes monitor to match window resolution
RLAPI void RL_ToggleBorderlessWindowed(void);                        // Toggle window state: borderless windowed, resizes window to match monitor resolution
RLAPI void RL_MaximizeWindow(void);                                  // Set window state: maximized, if resizable
RLAPI void RL_MinimizeWindow(void);                                  // Set window state: minimized, if resizable
RLAPI void RL_RestoreWindow(void);                                   // Set window state: not minimized/maximized
RLAPI void RL_SetWindowIcon(RL_Image image);                            // Set icon for window (single image, RGBA 32bit)
RLAPI void RL_SetWindowIcons(RL_Image *images, int count);              // Set icon for window (multiple images, RGBA 32bit)
RLAPI void RL_SetWindowTitle(const char *title);                     // Set title for window
RLAPI void RL_SetWindowPosition(int x, int y);                       // Set window position on screen
...
RLAPI void RL_SetWindowOpacity(float opacity);                       // Set window opacity [0.0f..1.0f]
RLAPI void RL_SetWindowFocused(void);                                // Set window focused
...
RLAPI int RL_GetCurrentMonitor(void);                                // Get current monitor where window is placed
...
RLAPI RL_Image GetClipboardImage(void);                              // Get clipboard image content
...
RLAPI bool IsShaderValid(RL_Shader shader);                                   // Check if a shader is valid (loaded on GPU)
...
RLAPI RL_Ray RL_GetScreenToWorldRay(RL_Vector2 position, RL_Camera camera);         // Get a ray trace from screen position (i.e mouse)
RLAPI RL_Ray RL_GetScreenToWorldRayEx(RL_Vector2 position, RL_Camera camera, int width, int height); // Get a ray trace from screen position (i.e mouse) in a viewport
...
RLAPI bool RL_IsFileNameValid(const char *fileName);                 // Check if fileName is valid for the platform/OS
RLAPI RL_FilePathList RL_LoadDirectoryFiles(const char *dirPath);       // Load directory filepaths
RLAPI RL_FilePathList RL_LoadDirectoryFilesEx(const char *basePath, const char *filter, bool scanSubdirs); // Load directory filepaths with extension filtering and recursive directory scan. Use 'DIR' in the filter string to include directories in the result
...
RLAPI bool RL_IsKeyPressedRepeat(int key);                       // Check if a key has been pressed again
...
RLAPI void RL_SetGamepadVibration(int gamepad, float leftMotor, float rightMotor, float duration); // Set gamepad vibration for both motors (duration in seconds)
...
RLAPI float RL_GetGestureHoldDuration(void);               // Get gesture hold time in seconds
...
RLAPI RL_Texture2D RL_GetShapesTexture(void);                                 // Get texture that is used for shapes drawing
RLAPI RL_Rectangle RL_GetShapesTextureRectangle(void);                        // Get texture source rectangle that is used for shapes drawing

// Basic shapes drawing functions
RLAPI void RL_DrawPixel(int posX, int posY, RL_Color color);                                                   // Draw a pixel using geometry [Can be slow, use with care]
RLAPI void RL_DrawPixelV(RL_Vector2 position, RL_Color color);                                                    // Draw a pixel using geometry (Vector version) [Can be slow, use with care]
...
RLAPI void RL_DrawCircleGradient(int centerX, int centerY, float radius, RL_Color inner, RL_Color outer);         // Draw a gradient-filled circle
...
RLAPI void RL_DrawRectangleGradientV(int posX, int posY, int width, int height, RL_Color top, RL_Color bottom);   // Draw a vertical-gradient-filled rectangle
RLAPI void RL_DrawRectangleGradientH(int posX, int posY, int width, int height, RL_Color left, RL_Color right);   // Draw a horizontal-gradient-filled rectangle
RLAPI void RL_DrawRectangleGradientEx(RL_Rectangle rec, RL_Color topLeft, RL_Color bottomLeft, RL_Color topRight, RL_Color bottomRight); // Draw a gradient-filled rectangle with custom vertex colors
...
RLAPI void RL_DrawRectangleRoundedLinesEx(RL_Rectangle rec, float roundness, int segments, float lineThick, RL_Color color); // Draw rectangle with rounded edges outline
...
RLAPI RL_Vector2 RL_GetSplinePointLinear(RL_Vector2 startPos, RL_Vector2 endPos, float t);                           // Get (evaluate) spline point: Linear
RLAPI RL_Vector2 RL_GetSplinePointBasis(RL_Vector2 p1, RL_Vector2 p2, RL_Vector2 p3, RL_Vector2 p4, float t);              // Get (evaluate) spline point: B-Spline
RLAPI RL_Vector2 RL_GetSplinePointCatmullRom(RL_Vector2 p1, RL_Vector2 p2, RL_Vector2 p3, RL_Vector2 p4, float t);         // Get (evaluate) spline point: Catmull-Rom
RLAPI RL_Vector2 RL_GetSplinePointBezierQuad(RL_Vector2 p1, RL_Vector2 c2, RL_Vector2 p3, float t);                     // Get (evaluate) spline point: Quadratic Bezier
RLAPI RL_Vector2 RL_GetSplinePointBezierCubic(RL_Vector2 p1, RL_Vector2 c2, RL_Vector2 c3, RL_Vector2 p4, float t);        // Get (evaluate) spline point: Cubic Bezier
...
RLAPI bool RL_CheckCollisionCircleLine(RL_Vector2 center, float radius, RL_Vector2 p1, RL_Vector2 p2);               // Check if circle collides with a line created betweeen two points [p1] and [p2]
...
RLAPI bool RL_CheckCollisionPointPoly(RL_Vector2 point, const RL_Vector2 *points, int pointCount);                // Check if point is within a polygon described by array of vertices
...
RLAPI RL_Image RL_LoadImageAnimFromMemory(const char *fileType, const unsigned char *fileData, int dataSize, int *frames); // Load image sequence from memory buffer
...
RLAPI bool IsImageValid(RL_Image image);                                                                    // Check if an image is valid (data and parameters)
...
RLAPI RL_Image RL_ImageFromChannel(RL_Image image, int selectedChannel);                                          // Create an image from a selected channel of another image (GRAYSCALE)
...
RLAPI void RL_ImageKernelConvolution(RL_Image *image, const float *kernel, int kernelSize);                    // Apply custom square convolution kernel to image
...
RLAPI void RL_ImageDrawLineEx(RL_Image *dst, RL_Vector2 start, RL_Vector2 end, int thick, RL_Color color);              // Draw a line defining thickness within an image
...
RLAPI void RL_ImageDrawTriangle(RL_Image *dst, RL_Vector2 v1, RL_Vector2 v2, RL_Vector2 v3, RL_Color color);               // Draw triangle within an image
RLAPI void RL_ImageDrawTriangleEx(RL_Image *dst, RL_Vector2 v1, RL_Vector2 v2, RL_Vector2 v3, RL_Color c1, RL_Color c2, RL_Color c3); // Draw triangle with interpolated colors within an image
RLAPI void RL_ImageDrawTriangleLines(RL_Image *dst, RL_Vector2 v1, RL_Vector2 v2, RL_Vector2 v3, RL_Color color);          // Draw triangle outline within an image
RLAPI void RL_ImageDrawTriangleFan(RL_Image *dst, RL_Vector2 *points, int pointCount, RL_Color color);               // Draw a triangle fan defined by points within an image (first vertex is the center)
RLAPI void RL_ImageDrawTriangleStrip(RL_Image *dst, RL_Vector2 *points, int pointCount, RL_Color color);             // Draw a triangle strip defined by points within an image
...
RLAPI bool IsTextureValid(RL_Texture2D texture);                                                            // Check if a texture is valid (loaded in GPU)
RLAPI void RL_UnloadTexture(RL_Texture2D texture);                                                             // Unload texture from GPU memory (VRAM)
RLAPI bool IsRenderTextureValid(RL_RenderTexture2D target);                                                 // Check if a render texture is valid (loaded in GPU)
...
RLAPI bool RL_ColorIsEqual(RL_Color col1, RL_Color col2);                            // Check if two colors are equal
...
RLAPI RL_Color ColorLerp(RL_Color color1, RL_Color color2, float factor);            // Get color lerp interpolation between two colors, factor [0.0f..1.0f]
...
RLAPI RL_Font RL_LoadFontEx(const char *fileName, int fontSize, int *codepoints, int codepointCount); // Load font from file with extended parameters, use NULL for codepoints and 0 for codepointCount to load the default character set, font size is provided in pixels height
...
RLAPI bool IsFontValid(RL_Font font);                                                          // Check if a font is valid (font data loaded, WARNING: GPU texture not checked)
...
RLAPI const char *RL_TextToSnake(const char *text);                      // Get Snake case notation version of provided string
RLAPI const char *RL_TextToCamel(const char *text);                      // Get Camel case notation version of provided string

RLAPI int RL_TextToInteger(const char *text);                            // Get integer value from text (negative values not supported)
RLAPI float RL_TextToFloat(const char *text);                            // Get float value from text (negative values not supported)
...
RLAPI bool IsModelValid(RL_Model model);                                                       // Check if a model is valid (loaded in GPU, VAO/VBOs)
...
RLAPI void DrawModelPoints(RL_Model model, RL_Vector3 position, float scale, RL_Color tint); // Draw a model as points
RLAPI void DrawModelPointsEx(RL_Model model, RL_Vector3 position, RL_Vector3 rotationAxis, float rotationAngle, RL_Vector3 scale, RL_Color tint); // Draw a model as points with extended parameters
RLAPI void RL_DrawBoundingBox(RL_BoundingBox box, RL_Color color);                                   // Draw bounding box (wires)
RLAPI void RL_DrawBillboard(RL_Camera camera, RL_Texture2D texture, RL_Vector3 position, float scale, RL_Color tint);   // Draw a billboard texture
...
RLAPI bool RL_ExportMeshAsCode(RL_Mesh mesh, const char *fileName);                               // Export mesh as code file (.h) defining multiple arrays of vertex attributes
...
RLAPI bool IsMaterialValid(RL_Material material);                                              // Check if a material is valid (shader assigned, map textures loaded in GPU)
...
RLAPI void RL_UpdateModelAnimation(RL_Model model, RL_ModelAnimation anim, int frame);               // Update model animation pose (CPU)
RLAPI void UpdateModelAnimationBones(RL_Model model, RL_ModelAnimation anim, int frame);          // Update model animation mesh bone matrices (GPU skinning)
...
RLAPI bool IsWaveValid(RL_Wave wave);                                    // Checks if wave data is valid (data loaded and parameters)
...
RLAPI bool IsSoundValid(RL_Sound sound);                                 // Checks if a sound is valid (data loaded and buffers initialized)
...
RLAPI bool IsMusicValid(RL_Music music);                                 // Checks if a music stream is valid (context and buffers initialized)
...
RLAPI bool IsAudioStreamValid(RL_AudioStream stream);                    // Checks if an audio stream is valid (buffers initialized)
